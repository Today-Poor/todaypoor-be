...
public class CrewController {
    ...
    public ResponseEntity<ApiResponse<CreateCrewResponse>> createCrew(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(crewService.createCrew(userDetails.getUserId(), request)));
    }
    ...
    public ResponseEntity<ApiResponse<UpdateCrewResponse>> updateCrew(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.updateCrew(userDetails.getUserId(), crewId, request)));
    }
    ...
    public ResponseEntity<ApiResponse<InviteCodeResponse>> reissueInviteCode(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.reissueInviteCode(userDetails.getUserId(), crewId)));
    }
    ...
    public ResponseEntity<ApiResponse<InviteCodeResponse>> getInviteCode(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.getInviteCode(userDetails.getUserId(), crewId)));
    }
    ...
    public ResponseEntity<ApiResponse<MyCrewListResponse>> getMyCrews(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.getMyCrews(userDetails.getUserId())));
    }
    ...
    public ResponseEntity<ApiResponse<CrewDetailResponse>> getCrewDetail(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.getCrewDetail(userDetails.getUserId(), crewId)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteCrew(
        ...
        crewService.deleteCrew(userDetails.getUserId(), crewId);
    ...
    public ResponseEntity<ApiResponse<CrewMainResponse>> getCrewMain(
        ...
        return ResponseEntity.ok(ApiResponse.success(crewService.getCrewMain(userDetails.getUserId(), crewId)));
    }
